...
public class Test05 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Account a=new Account("110-333-222222","홍길동",100000000,"0000");
			Account b=new Account("110-555-888888","박길동",1000,"1111");
			set.add(a);
			set.add(b);
			set.add(a);
			set.add(new Account("110-000-000000","최길동",2000,"9999"));
			oos.writeObject(set);
			oos.flush();
